    ...
    <>
      <section className="flex flex-col gap-8">
        <div className="flex flex-col">
          ...
          <p className="font-aileron text-sm">FR.APL.01</p>
        </div>
        <div>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <div className="flex flex-col gap-12">
                <div className="flex flex-col gap-12 rounded-lg bg-white p-12">
                ...
                <div className="flex flex-col gap-12 rounded-lg bg-white p-12">
                  <p className="font-aileron text-xl font-semibold text-secondary-500">
                            ...
                            <FormItem className="w-full self-end">
                              ...
                              <FormControl>
                                <Upload
                                  ...
                                  accept={"image/*"}
                                  variant={
                                    form.formState.errors?.foto_profil
                                      ? "error"
                                      : "primary"
                                  }
                                />
