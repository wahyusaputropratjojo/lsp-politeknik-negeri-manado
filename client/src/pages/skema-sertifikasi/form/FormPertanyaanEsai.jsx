...
export const FormPertanyaanEsai = ({ form }) => {
    ...
    <div key={item.id}>
      <Accordion type="single" collapsible>
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            <PertanyaanEsai indexUnitKompetensi={index} form={form} />
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
...
const PertanyaanEsai = ({ indexUnitKompetensi, form }) => {
    ...
    return (
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <FormField
            control={form.control}
            name={`unit_kompetensi.${indexUnitKompetensi}.pertanyaan_esai.${index}.pertanyaan`}
            render={({ field }) => (
        ...
        <div className="flex flex-col gap-1">
          ...
          <FormField
            control={form.control}
            name={`unit_kompetensi.${indexUnitKompetensi}.pertanyaan_esai.${index}.jawaban`}
            render={({ field }) => (
              <FormItem className="relative">
                <FormLabel className="absolute -left-2 top-1 -translate-x-full">
                  {index + 1}
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-12">{pertanyaanEsaiFields}</div>
      <Button
